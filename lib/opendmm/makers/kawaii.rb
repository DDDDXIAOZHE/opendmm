      ...
      module Parser
        def self.parse(content)
          ...
          return {
            ...
            cover_image:     html.css('#content > div.col300 > span.pake > p.textright > a > img').first['src'].gsub(/pm.jpg$/, 'pl.jpg'),
            ...
            thumbnail_image: html.css('#content > div.col300 > span.pake > p.textright > a > img').first['src'],
          }
        end
      end
    end
