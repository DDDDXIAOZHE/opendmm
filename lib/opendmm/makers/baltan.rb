      ...
      module Parser
        def self.parse(content)
          ...
          return {
            ...
            movie_length:  ChronicDuration.parse(html.xpath('//*[@id="content1"]/section/div[2]/table/tr[2]/td').text),
            page:          page_uri.to_s,
            release_date:  Date.parse(html.xpath('//*[@id="content1"]/section/div[2]/table/tr[3]/td').text),
