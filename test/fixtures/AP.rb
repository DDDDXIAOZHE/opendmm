module Fixture
  AP = {
    "AP-018" => {
      ...
      descriptions: [
        "琥珀うた、青空小夏、愛内希、松下ひかり、椿すずの未だ媚薬未経験で媚薬の効果を信じていない人気ＡＶ女優５名に即行性超強力媚薬を飲ませ、ラッシュ時の超満員バスに乗せると、効果絶大！他の乗客の肩が触れるだけでも感じまくり、バスの車内だと言うのに我慢できずに失禁しながらイキまくる全身性感帯女に豹変！ サンプル画像",
      ],
    },
  }
end